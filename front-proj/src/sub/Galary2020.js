          ...
          <div className='ga-sub-title'>
            <ul className='galary-menu'>
              <li ><Link to={"/galary2022"} >
                <div className={`ga-li-width ${is2022Hovered ? "ga-point" : ""}`}
              ...
              ><div onMouseEnter={() => { setIsGaOn(false); setis2020Hovered(true); }} onMouseLeave={() => { setIsGaOn(true); setis2020Hovered(false); }} className={`ga-li-width ${isGaOn?"gaOn":""}  ${is2020Hovered ? 'ga-point' : ''}`}>2020</div></Link></li>
            </ul>
          </div>
