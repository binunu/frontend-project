          ...
          <ul className='season-menu'>
            ...
            <li ><Link to={"/scheduleWinter"} >
              <div onMouseEnter={() => { setIsOn(false); setIsWinterHovered(true); }} onMouseLeave={() => { setIsOn(true); setIsWinterHovered(false); }}
                className={`white li-width ${isOn ? "on" : ""} ${isWinterHovered ? "sd-point" : ""}`} >겨울</div></Link></li>
          </ul>
        </div>
                  ...
                  <a href=''>
                    <div className='sd-con-frame scf3' >
                      ...
                      <ImageWithText imageUrl='/img/Ready.jpg'
                        propsText={<p><em>2023<br />겨울 페스티벌 1</em></p>} />
                    </div>
                  </a>
                  <div className='link-box'>
                    <br /><p>겨울  페스티벌<br />2023. 12. 28 ~ 12. 30</p>
                  </div>
                </td>
                <td>
                  <a href=''>
                    <div className='' >
                      <ImageWithText imageUrl='/img/Ready.jpg'
                        propsText={<p><em>2023<br />겨울 페스티벌 2</em></p>} />
                    </div>
                  </a>
                  <div className='link-box'>
                    <p><br />겨울  페스티벌<br /> 2024. 1. 12 ~ 1. 1</p>
                  </div>
                </td>
                <td>
                  <a href=''>
                    <div className='sd-con-frame scf4' >
                      <ImageWithText imageUrl='/img/Ready.jpg'
                        propsText={<p><em>2024<br />겨울 페스티벌 3</em></p>} />
                    </div>
                  </a>
                  <div className='link-box'>
                    <p><br />겨울  페스티벌<br />2024. 1. 13 ~ 1. 28</p>
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <a href=''>
                    <div className='sd-con-frame scf4' >
                      <ImageWithText imageUrl='/img/Ready.jpg'
                        propsText={<p><em>2024<br />겨울 페스티벌 4</em></p>} />
                    </div>
                  </a>
                  <div className='link-box'>
                    <p><br />겨울  페스티벌<br />2024. 2. 2 ~ 2. 7</p>
                  </div>
                </td>
                ...
                <td>
                  <a href=''>
                    <div className='sd-con-frame scf2' >
                      ...
                      <ImageWithText imageUrl='/img/Ready.jpg'
                        propsText={<p><em>2024<br />겨울 페스티벌 5</em></p>} />
                    </div>
                  </a>
                  <div className='link-box'>
                    <p><br />겨울  페스티벌<br /> 2024. 2. 26 ~ 2. 22</p>
                  </div>
                </td>
                <td>
                  <a href=''>
                    <div className='sd-con-frame scf2' >
                      {/*  style={{  backgroundImage: "url('/img/p_jazz.gif')"}} */}
                      <ImageWithText imageUrl='/img/Ready.jpg'
                        propsText={<p><em>2024<br />겨울 페스티벌 6</em></p>} />
                    </div>
                  </a>
                  <div className='link-box'>
                    <p><br />겨울  페스티벌<br /> 2024. 2. 26 ~ 2. 28</p>
                  </div>
                </td>
