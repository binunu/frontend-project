      ...
      <div className='sd-body'>
        ...
        <div className='sd-sub-title'>
          <ul className='season-menu'>
            <li><Link to={"/scheduleSpring"} className='spoint'>봄</Link></li>
            <li><Link to={"/scheduleSummer"} className='supoint'>여름</Link></li>
            <li><Link to={"/scheduleFall"} className='fpoint'>가을</Link></li>
            <li className='sd-point'><Link to={"/scheduleWinter"} className='white'>겨울</Link></li>
          </ul>
        </div>
