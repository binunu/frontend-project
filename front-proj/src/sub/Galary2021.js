        ...
        <div className="ga-body">
          ...
          <div className='ga-sub-title'>
            <ul className='galary-menu'>
              ...
              ><div onMouseEnter={() => { setIsGaOn(false); setis2021Hovered(true); }} onMouseLeave={() => { setIsGaOn(true); setis2021Hovered(false); }} className={`ga-li-width ${isGaOn?"gaOn":""} ${is2021Hovered ? 'ga-point' : ''}`}>2021</div></Link></li>
