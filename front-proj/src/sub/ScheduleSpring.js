          ...
          <ul className="season-menu">
            <li>
              <Link to={"/scheduleSpring"}>
                <div
                  className={`white li-width ${isOn ? "on" : ""} ${
                    isSpringHovered ? "sd-point" : ""
                  }`}
                  onMouseEnter={() => {
                    setIsOn(false);
            ...
            <li>
              <Link to={"/scheduleFall"}>
                <div
                  ...
                  className={`li-width ${isFallHovered ? "sd-point" : ""}`}
                >
                  가을
                </div>
              </Link>
            ...
            <li>
              <Link to={"/scheduleWinter"}>
                <div
                  ...
                  className={`li-width ${isWinterHovered ? "sd-point" : ""}`}
                >
                  겨울
                </div>
              </Link>
