      ...
      <div className='sd-body'>
        ...
        <div className='sd-sub-title'> 
          <ul className='season-menu'>
            ...
            ><div onMouseEnter={() => { setIsOn(false);setIsFallHovered(true);  }} onMouseLeave={() => {  setIsOn(true); setIsFallHovered(false);  }} className={`li-width ${isOn ? "on" : ""} ${isFallHovered ? 'sd-point' : ''}`}>가을</div></Link></li>
          ...
          <table className='sd-content' >
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <ImageWithText imageUrl='/img/Ready.jpg' 
                    propsText={<p><em>2023<br/>가을페스티벌 1</em></p>}/>
                  </div>
                  </a>
                ...
                <td>
                  ...
                  <div className='' > 
                  <ImageWithText imageUrl='/img/Ready.jpg' 
                   propsText={<p><em>2023<br/>가을페스티벌 2</em></p>}/>
                  </div>
                  </a>
                  <div className='link-box'>
                    <p><br/>가을 페스티벌<br/> 2023. 5. 4 ~ 5. 7</p>
                </div>
                </td>
                <td>
                  <a href=''>
                  ...
                  <ImageWithText imageUrl='/img/Ready.jpg' 
                   propsText={<p><em>2023<br/>가을페스티벌 3</em></p>}/>
                  </div>
                  </a>
                  <div className='link-box'>
                    <p><br/>가을 페스티벌<br/>2023. 5. 13 ~ 5. 28</p>
                </div>
                </td>
              ...
              <td>
                  ...
                  <div className='sd-con-frame scf4' > 
                  <ImageWithText imageUrl='/img/Ready.jpg' 
                  propsText={<p><em>2023<br/>가을페스티벌 4</em></p>}/>
                  </div>
                  </a>
                  <div className='link-box'>
                    <p><br/>가을 페스티벌<br/>2023. 5. 5 ~ 5. 7</p>
                </div>
                </td>
              ...
              <td>
                  ...
                  <div className='sd-con-frame scf2' >
                    ...
                    <ImageWithText imageUrl='/img/Ready.jpg' 
                    propsText={<p><em>2023<br/>가을페스티벌 5</em></p>}/>
                  </div>
                  </a>
                  <div className='link-box'>
                    <p><br/>가을 페스티벌<br/> 2023. 5. 26 ~ 5. 28</p>
                </div>
                </td>
                <td>
                  <a href=''>
                  <div className='sd-con-frame scf2' >
                    {/*  style={{  backgroundImage: "url('/img/p_jazz.gif')"}} */}
                    <ImageWithText imageUrl='/img/Ready.jpg' 
                    propsText={<p><em>2023<br/>가을페스티벌 6</em></p>}/>
                  </div>
                  </a>
                  <div className='link-box'>
                    <p><br/>가을 페스티벌<br/> 2023. 5. 26 ~ 5. 28</p>
